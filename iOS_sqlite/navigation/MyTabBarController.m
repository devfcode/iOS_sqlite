...
- (void)viewDidLoad {
    [super viewDidLoad];
    // 添加子控制器
    [self addOneViewController:[[BasicViewController alloc] init] image:@"tab_home_normal" selectedImage:@"tab_home_50" title:@"language"];
    [self addOneViewController:[[MyUtilViewController alloc] init] image:@"tab_c2c_normal" selectedImage:@"tab_c2c_50" title:@"ui"];
